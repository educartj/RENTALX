...
categoriesRoutes.post('/', _ensureAdmin.ensureAdmin, _ensureAuthenticated.ensureAuthenticated, createCategoryController.handle);
categoriesRoutes.get('/', listCategoriesController.handle);
categoriesRoutes.post('/import', upload.single('file'), _ensureAdmin.ensureAdmin, _ensureAuthenticated.ensureAuthenticated, importCategoryController.handle);